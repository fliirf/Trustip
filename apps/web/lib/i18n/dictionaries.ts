...
const id = {
  ...
  checkout: {
    ...
    trust: {
      ...
      reviews: (n: number) => `${n} penilaian`,
      completed: (n: number) => `${n} pesanan selesai`,
    },
    stages: [
  ...
  status: {
    ...
    station01: {
      ...
      noteRefunded: "Pembayaran kamu sudah dikembalikan ke wallet pembayar.",
    ...
    station02: {
      ...
      noteRefunded: "Dana sudah dikembalikan ke wallet pembayar kamu.",
    ...
    refund: {
      helpCta: "Ajukan Bantuan / Refund",
      dialogEyebrow: "Ajukan Refund",
      intro:
        "Ada masalah dengan pesanan ini? Ajukan refund. Dana kamu tetap ditahan dan tidak diteruskan ke penjual sampai tim kami selesai meninjau pengajuan.",
      reasonLabel: "Alasan",
      reasons: {
        not_received: "Pesanan tidak sampai",
        wrong_item: "Barang tidak sesuai",
        damaged: "Barang rusak",
        fake: "Barang palsu",
        seller_unresponsive: "Penjual tidak merespons",
        other: "Lainnya",
      } as Record<string, string>,
      descriptionLabel: "Ceritakan masalahnya (opsional)",
      descriptionPlaceholder: "Contoh: paket belum sampai padahal resi sudah lama tidak bergerak…",
      submit: "Kirim Pengajuan",
      cancel: "Batal",
      submitting: "Mengirim pengajuan…",
      openTitle: "Pengajuan Refund Sedang Ditinjau",
      openBody:
        "Dana kamu tetap ditahan selama peninjauan dan tidak diteruskan ke penjual. Tim kami akan meninjau pengajuan ini.",
      approvedTitle: "Refund Disetujui",
      approvedBody: "Refund kamu disetujui dan sedang diproses kembali ke wallet pembayar.",
      rejectedTitle: "Pengajuan Refund Ditolak",
      rejectedBody:
        "Setelah ditinjau, pengajuan refund ini ditolak. Kalau barang sudah kamu terima, kamu tetap bisa mengonfirmasi penerimaan.",
      completedTitle: "Dana Dikembalikan",
      completedBody: "Dana sudah dikembalikan ke wallet pembayar kamu.",
      error: {
        Conflict: "Sudah ada pengajuan refund untuk pesanan ini.",
        RateLimited: "Terlalu banyak percobaan. Tunggu sebentar, lalu coba lagi.",
        CheckoutNotFound: "Pesanan ini tidak bisa diajukan refund.",
        default: "Terjadi kesalahan. Silakan coba lagi.",
      } as Record<string, string>,
      evidence: {
        title: "Lampirkan Bukti",
        intro: "Tambahkan foto, video, atau dokumen sebagai bukti (opsional). Ini membantu tim kami meninjau pengajuanmu dengan adil.",
        typeLabel: "Jenis bukti",
        types: {
          item_photo: "Foto barang",
          unboxing_video: "Video unboxing",
          chat_screenshot: "Tangkapan layar chat",
          shipping_receipt: "Bukti pengiriman",
          other: "Lainnya",
        } as Record<string, string>,
        chooseFile: "Pilih file (maks 10 MB)",
        upload: "Unggah Bukti",
        uploading: "Mengunggah…",
        uploaded: "Bukti berhasil diunggah.",
    ...
    review: {
      ...
      ratingLabel: "Rating",
      ratingValue: (n: number) => `${n} dari 5 bintang`,
      commentLabel: "Ulasan (opsional)",
      commentPlaceholder: "Contoh: barang sesuai deskripsi, pengiriman cepat…",
      submit: "Kirim Penilaian",
      submitting: "Mengirim…",
      submittedTitle: "Penilaian Kamu",
      error: {
        OrderNotEligible: "Penilaian hanya bisa diberikan setelah pesanan selesai.",
        AlreadyReviewed: "Kamu sudah memberi penilaian untuk pesanan ini.",
        RateLimited: "Terlalu banyak percobaan. Tunggu sebentar, lalu coba lagi.",
        CheckoutNotFound: "Pesanan ini tidak bisa dinilai.",
        default: "Terjadi kesalahan. Silakan coba lagi.",
      } as Record<string, string>,
    },
  },
  seller: {
    ...
    trust: {
      needLoginDetail: "Masuk untuk melihat Trust Profile toko kamu.",
      heading: "Trust Profile",
      subtitle: "Reputasi toko kamu dihitung otomatis dari pesanan selesai, refund, dan penilaian pembeli.",
      loading: "Memuat trust profile",
      reload: "Muat Ulang",
      signInAgain: "Masuk Lagi",
      trustScore: "Skor",
      completed: "Selesai",
      refunded: "Refund",
      refundRate: "Rasio Refund",
      reviews: "Penilaian",
      avgRating: "Rata-rata",
      reviewsTitle: "Penilaian Pembeli",
      noReviews: "Belum ada penilaian.",
      ...
      events: {
        ...
        review_received: "Penilaian masuk",
        seller_restricted: "Toko dibatasi",
        manual_adjustment: "Penyesuaian manual",
      } as Record<string, string>,
    },
    payouts: {
      needLoginDetail: "Masuk untuk mengatur metode payout toko kamu.",
      heading: "Metode Payout",
      subtitle: "Atur ke mana dana pesanan diteruskan. USDC/XLM memakai wallet yang sudah kamu verifikasi; MoneyGram adalah rute cash-out terpandu. Halaman ini tidak memindahkan dana.",
      reload: "Muat Ulang",
      addTitle: "01 · Tambah Metode",
      addNote: "USDC/XLM hanya bisa memakai wallet yang sudah terverifikasi (bukan alamat sembarang).",
      methodTypeLabel: "Jenis",
      types: {
        usdc_wallet: "Wallet USDC",
        xlm_wallet: "Wallet XLM",
        moneygram_cashout: "MoneyGram Cash-out",
      } as Record<string, string>,
      displayNameLabel: "Nama tampilan",
      displayNamePlaceholder: "mis. Wallet Utama",
      walletLabel: "Wallet terverifikasi",
      noVerifiedWallet: "Belum ada wallet terverifikasi.",
      goVerify: "Verifikasi wallet",
      pickWallet: "Pilih wallet…",
      pickWalletError: "Pilih wallet terverifikasi dulu.",
      primary: "Utama",
      countryLabel: "Negara (ISO-2)",
      currencyLabel: "Mata uang",
      setDefault: "Jadikan default",
      moneygramGuidedNote: "MoneyGram = rute terpandu; perlu peninjauan operasional sebelum aktif.",
      adding: "Menambahkan…",
      add: "Tambah Metode",
      listTitle: "02 · Metode Kamu",
      loading: "Memuat metode",
      empty: "Belum ada metode payout.",
      defaultBadge: "DEFAULT",
      statuses: {
        active: "Aktif",
        disabled: "Nonaktif",
        needs_review: "Perlu Ditinjau",
        unsupported_region: "Wilayah Tidak Didukung",
      } as Record<string, string>,
      makeDefault: "Jadikan default",
      disable: "Nonaktifkan",
      historyTitle: "03 · Riwayat Payout",
      historyNote: "Payout USDC langsung terjadi saat pembeli mengonfirmasi penerimaan — dana diteruskan ke wallet kamu on-chain.",
      historyEmpty: "Belum ada payout. Payout muncul setelah pesanan selesai.",
      viewTx: "Lihat transaksi",
      payoutStatuses: {
        not_requested: "Belum Diminta",
        route_selected: "Rute Dipilih",
      ...
      convert: {
        cta: "Konversi ke XLM",
        title: "Konversi USDC → XLM",
        note: "Dana USDC ada di wallet kamu. Tukar ke XLM lewat DEX Stellar — kamu yang menandatangani; Trustip tidak menyentuh dana.",
        quote: "Estimasi terima",
        minReceive: "Minimal diterima",
        connectWallet: "Hubungkan wallet payout",
        walletMismatch: "Wallet ini bukan wallet payout. Hubungkan wallet penerima dana.",
        wrongNetwork: "Wallet ada di jaringan yang salah. Ganti jaringan lalu coba lagi.",
        sign: "Tanda tangani & konversi",
...
const en: Dict = {
  ...
  checkout: {
    ...
    trust: {
      ...
      completed: (n: number) => `${n} orders completed`,
    },
    stages: [
  ...
  status: {
    ...
    station01: {
      ...
      noteRefunded: "Your payment has been returned to the paying wallet.",
    ...
    station02: {
      ...
      noteRefunded: "The funds have been returned to your paying wallet.",
    ...
    refund: {
      helpCta: "Request Help / Refund",
      dialogEyebrow: "Request a Refund",
      intro:
        "Something wrong with this order? Request a refund. Your funds stay held and are not forwarded to the seller until our team finishes reviewing the request.",
      reasonLabel: "Reason",
      reasons: {
        not_received: "Order never arrived",
      ...
      descriptionLabel: "Tell us what happened (optional)",
      descriptionPlaceholder: "Example: the package never arrived even though tracking hasn't moved in a long time…",
      submit: "Submit Request",
      cancel: "Cancel",
      submitting: "Submitting request…",
      openTitle: "Refund Request Under Review",
      openBody:
        "Your funds stay held during the review and are not forwarded to the seller. Our team will review this request.",
      approvedTitle: "Refund Approved",
      approvedBody: "Your refund is approved and being processed back to the paying wallet.",
      rejectedTitle: "Refund Request Declined",
      rejectedBody:
        "After review, this refund request was declined. If you've received the item, you can still confirm receipt.",
      completedTitle: "Funds Returned",
      completedBody: "The funds have been returned to your paying wallet.",
      error: {
        Conflict: "A refund request is already open for this order.",
        RateLimited: "Too many attempts. Wait a moment, then try again.",
        CheckoutNotFound: "This order isn't eligible for a refund request.",
        default: "Something went wrong. Please try again.",
      } as Record<string, string>,
      evidence: {
        title: "Attach Evidence",
        intro: "Add photos, video, or a document as evidence (optional). It helps our team review your request fairly.",
        ...
        chooseFile: "Choose a file (max 10 MB)",
    ...
    review: {
      ...
      ratingLabel: "Rating",
      ratingValue: (n: number) => `${n} out of 5 stars`,
      commentLabel: "Review (optional)",
      commentPlaceholder: "e.g. item matched the description, fast shipping…",
      submit: "Submit Rating",
      submitting: "Submitting…",
      submittedTitle: "Your Rating",
      error: {
        OrderNotEligible: "You can only review an order once it's completed.",
        AlreadyReviewed: "You've already reviewed this order.",
        RateLimited: "Too many attempts. Wait a moment, then try again.",
        CheckoutNotFound: "This order can't be reviewed.",
        default: "Something went wrong. Please try again.",
      } as Record<string, string>,
    },
  },
  seller: {
    ...
    trust: {
      needLoginDetail: "Sign in to view your store's Trust Profile.",
      heading: "Trust Profile",
      subtitle: "Your store's reputation, computed automatically from completed orders, refunds, and buyer ratings.",
      ...
      events: {
        ...
        seller_restricted: "Store restricted",
        manual_adjustment: "Manual adjustment",
      } as Record<string, string>,
    },
    payouts: {
      needLoginDetail: "Sign in to configure your store's payout methods.",
      heading: "Payout Methods",
      subtitle: "Configure where order funds are routed. USDC/XLM use a wallet you've already verified; MoneyGram is a guided cash-out route. This page moves no money.",
      reload: "Reload",
      addTitle: "01 · Add Method",
      addNote: "USDC/XLM can only use an already-verified wallet (never an arbitrary address).",
      methodTypeLabel: "Type",
      types: {
        usdc_wallet: "USDC Wallet",
        xlm_wallet: "XLM Wallet",
        moneygram_cashout: "MoneyGram Cash-out",
      } as Record<string, string>,
      displayNameLabel: "Display name",
      displayNamePlaceholder: "e.g. Main Wallet",
      walletLabel: "Verified wallet",
      noVerifiedWallet: "No verified wallet yet.",
      goVerify: "Verify a wallet",
      pickWallet: "Choose a wallet…",
      pickWalletError: "Pick a verified wallet first.",
      primary: "Primary",
      countryLabel: "Country (ISO-2)",
      currencyLabel: "Currency",
      setDefault: "Set as default",
      moneygramGuidedNote: "MoneyGram is a guided route; it needs operational review before it's active.",
      adding: "Adding…",
      add: "Add Method",
      listTitle: "02 · Your Methods",
      loading: "Loading methods",
      empty: "No payout methods yet.",
      defaultBadge: "DEFAULT",
      statuses: {
        active: "Active",
        disabled: "Disabled",
      ...
      disable: "Disable",
      historyTitle: "03 · Payout History",
      historyNote: "A direct USDC payout happens when the buyer confirms receipt — funds are forwarded to your wallet on-chain.",
      historyEmpty: "No payouts yet. Payouts appear once an order completes.",
      ...
      convert: {
        cta: "Convert to XLM",
        title: "Convert USDC → XLM",
        note: "The USDC is in your wallet. Swap it to XLM via the Stellar DEX — you sign; Trustip never touches the funds.",
        quote: "Estimated receive",
        minReceive: "Minimum received",
        connectWallet: "Connect payout wallet",
        walletMismatch: "This wallet is not the payout wallet. Connect the wallet that received the funds.",
        wrongNetwork: "Wallet is on the wrong network. Switch networks and try again.",
        sign: "Sign & convert",
        preparing: "Preparing…",
